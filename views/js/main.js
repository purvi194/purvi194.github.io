...
//document.body.scrolltop should not be called repeatedly
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var num_pizzas= (Math.ceil)(window.innerHeight / s * cols);//to limit the number of pizzas initiated
